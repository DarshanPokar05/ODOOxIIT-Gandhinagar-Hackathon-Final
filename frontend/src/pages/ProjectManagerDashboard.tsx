    ...
    <div style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '20px', marginBottom: '30px' }}>
        <div style={{ padding: '20px', backgroundColor: '#f8f9fa', borderRadius: '8px', border: '1px solid #dee2e6' }}>
          <h3>My Projects</h3>
          <p style={{ fontSize: '24px', fontWeight: 'bold', color: '#007bff' }}>{dashboardData?.data?.myProjects}</p>
        </div>
        <div style={{ padding: '20px', backgroundColor: '#f8f9fa', borderRadius: '8px', border: '1px solid #dee2e6' }}>
          <h3>Team Members</h3>
          <p style={{ fontSize: '24px', fontWeight: 'bold', color: '#28a745' }}>{dashboardData?.data?.teamMembers}</p>
        </div>
        <div style={{ padding: '20px', backgroundColor: '#f8f9fa', borderRadius: '8px', border: '1px solid #dee2e6' }}>
          <h3>Pending Tasks</h3>
